...
import { User, Mail, Lock, X, ArrowLeft, CheckCircle } from "lucide-react";
        ...
        <div className="glass-card p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-card border border-border/50 flex items-center justify-center text-muted-foreground transition-colors hover:text-foreground hover:border-primary/40"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          {/* Toggle Sign In/Up - Hidden in forgot password mode */}
          {!isForgotPassword && (
